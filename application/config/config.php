...
|
*/
// $config['base_url'] = 'http://localhost/cia_curd/';

$rbd_root  = "http://".$_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
$config['base_url'] = $rbd_root;
